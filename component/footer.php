    ...
    <div class="container mx-auto flex flex-wrap justify-between items-center gap-8 py-8 px-6">
        ...
        <div class="flex flex-col gap-3">
            <div class="flex items-center gap-4 no-select">
              <h4 class="font-bold text-xl text-white">Accounts</h4>
              <i class="bi bi-journal-album text-xl text-basecolor"></i>
            </div>
            <a href="#" class="footerLinks font-semibold">Savings</a>
            <a href="#" class="footerLinks font-semibold">Current</a>
