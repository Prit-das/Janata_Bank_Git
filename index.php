...
<body>
  ...
  <section id="outer-wrapper" class="relative overflow-x-hidden">
    ...
    <hero id="hero" class="relative">
      ...
      <!-- Hero Text -->
      <div
        class="absolute flex flex-col gap-5 bottom-0 left-[50%] translate-x-[-50%] h-[75%] w-full text-white font-poppins z-40 md:px-12 px-4 py-4">
            ...
            <div class="swiper-wrapper flex justify-start items-center space-x-4 lg:space-x-0 mb-10">
              ...
              <div class="swiper-slide">
                <div class="relative h-[28rem] flex flex-col shadow-lg rounded-xl">
                  <div class="cardsUpper rounded-xl">
                    <img
                      src="https://images.unsplash.com/photo-1721378467004-eb44b57fa361?q=80&w=1997&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                      class="object-right">
                  </div>
                  <div class="cardsLower flex flex-col justify-end items-start rounded-xl select-none gap-4 px-4 py-6">
    ...
    <section id="services" class="relative font-poppins px-4">
      <div class="container mx-auto px-4 lg:px-12 py-4">
        <!-- Heading -->
        <h4 class="hidden lg:block font-bold text-center md:text-start text-4xl lg:text-6xl text-darkbasecolor">
          Remittance Calculator</h4>
        <!-- Calculator & Text container -->
        <div class="flex flex-col md:flex-row justify-between items-center gap-8 py-8 md:py-16" id="calcContainer">
          <!-- Left Section -->
          <div class="w-full md:w-1/2 font-poppins mb-8 md:mb-0">
            <h1 class="text-3xl md:text-4xl lg:text-6xl font-extrabold text-center md:text-left">
              <span class="text-slate">Live currency</span>
              <span class="text-slate block md:inline">exchange rates</span>
            </h1>
            <h2
              class="text-3xl md:text-4xl lg:text-6xl font-extrabold text-darkbasecolor mt-4 text-center md:text-left">
              Calculator</h2>
            <p class="max-w-lg text-slate mt-8 text-center md:text-left">Keep up with all your fiat foreign currencies
          ...
          <!-- Right section -->
          <div class="w-full md:w-1/2 font-poppins">
            <!-- Calculator -->
            <div
              class="glassmorphisum flex flex-col items-center rounded-lg px-6 sm:px-12 md:px-16 lg:px-24 py-8 md:py-12">
              <!-- Group one -->
              ...
              <div
                ...
                <div class="flex items-center gap-2 select-none">
                  ...
                  <p class="text-slate font-extrabold">UAE</p>
                </div>
              </div>
              <!-- Group two -->
              ...
              <div
                ...
                <div class="flex items-center select-none gap-2">
                  ...
                  <p class="text-slate font-extrabold">Bangladesh</p>
                </div>
              </div>
            </div>
          </div>
